...
- useEffect: React does a shallow comparison when looking to see if values in
  the dependency array have changed
- useRef: Provides a `ref` object which is an object that you can mutate without
  trigerring re-renders
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=hamza.basrai%40gmail.com).
